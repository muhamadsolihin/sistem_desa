            ...
            <div class="d-flex flex-wrap justify-content-left">
                <div class="col-md-5">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="orgtua_pengaju" name="orgtua_pengaju" required>
                    </div>
                    <div class="mb-3">
                        <label for="tempat_lahir_pengaju" class="form-label">Tempat Lahir</label>
                        <input type="text" class="form-control" id="tempat_lahir_pengaju" name="tempat_lahir_pengaju" required>
                    </div>
                    <div class="mb-3">
                        <label for="tanggal_lahir_pengaju" class="form-label">Tanggal Lahir</label>
                        <input type="date" class="form-control" id="tanggal_lahir_pengaju" name="tanggal_lahir_pengaju" required>
                    </div>
                    <div class="mb-3">
                        <label for="pekerjaan_pengaju" class="form-label">Pekerjaan</label>
                        <input type="text" class="form-control" id="pekerjaan_pengaju" name="pekerjaan_pengaju" required>
                    </div>
                    <div class="mb-3">
